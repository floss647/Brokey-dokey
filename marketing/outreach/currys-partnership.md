...
```
Customer brings broken device to Currys store
        ↓
Staff scan a QR code → BrokeyDokey web form
        ↓
Customer enters device details (photo + category)
        ↓
If repayable/sellable: listed on BrokeyDokey marketplace
If irreparable: routed to certified WEEE recycler
        ↓
Customer receives £30 Currys voucher code by email within 24h
        ↓
Customer redeems at currys.co.uk or in-store
```

BrokeyDokey handles: intake form, voucher issuance, device routing, reporting.
Currys handles: voucher redemption backend, in-store QR placement.
...
In return:
- BrokeyDokey handles all customer-facing comms and device logistics
- Monthly reporting: devices processed, categories, ESG weight diverted from landfill
- Full co-brand available on BrokeyDokey site, social, and press
...
**Duration:** 3 months  
**Stores:** 5–10 (suggest mixed: 2 London, 2 regional cities, 1 Scotland)  
**Volume target:** 500 devices in pilot  
**Success metric:** Voucher redemption rate + gross purchase value driven  

If pilot hits 500 devices: Currys has diverted ~750kg of e-waste and driven ~£15,000 in store purchases (assuming 50% redemption at avg £60 basket).

---

## Target Contacts at Currys

| Role | Why | Where to find |
|---|---|---|
| Head of Sustainability / ESG | Owns the recycling programme | LinkedIn: search "Currys sustainability" |
| Head of Corporate Partnerships | Commercial deals | LinkedIn |
...
**The mechanic:** Customer recycles a broken device at Currys → gets a £30 Currys voucher via BrokeyDokey → redeems at currys.co.uk or in-store. BrokeyDokey handles intake and device routing; Currys provides the vouchers.
...
The headline writes itself: *"Currys will pay you £30 to recycle your broken tech."*
...
| Day | Action |
|---|---|
| Day 1 | Send Version C to press@currys.co.uk |
| Day 1 | Send Version A to sustainability contact found on LinkedIn |
| Day 5 | Follow up on both if no response |
| Day 10 | Try Version B to partnerships@currys.co.uk |
| Day 15 | Final follow-up; move to next retailer if no response |
