...
.nav-logo { font-family: var(--serif); font-size: 23px; letter-spacing: -0.4px; color: var(--text); }
.nav-links { display: flex; gap: 36px; list-style: none; }
.nav-links a { font-size: 12px; font-weight: 600; letter-spacing: 0.07em; text-transform: uppercase; color: var(--muted); transition: color 0.15s; }
.nav-links a:hover { color: var(--text); }

.hero-grid { display: grid; grid-template-columns: repeat(3, 1fr); height: 88vh; min-height: 540px; }
.hp { position: relative; overflow: hidden; display: block; background: #111; border-right: 1px solid rgba(255,255,255,0.07); }
.hp:last-child { border-right: none; }
.hp-bg { position: absolute; inset: 0; background-size: cover; background-position: center; opacity: 0.5; transition: opacity 0.4s ease, transform 0.7s ease; }
.hp:hover .hp-bg { opacity: 0.68; transform: scale(1.05); }
.hp-overlay { position: absolute; inset: 0; background: linear-gradient(to top, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.15) 100%); }
.hp-label { position: absolute; top: 28px; left: 28px; font-size: 11px; font-weight: 700; letter-spacing: 0.16em; text-transform: uppercase; }
.hp-body { position: absolute; bottom: 0; left: 0; right: 0; padding: 32px 28px; }
.hp-title { font-family: var(--serif); font-size: clamp(1.05rem, 1.6vw, 1.5rem); line-height: 1.22; color: #fff; text-wrap: balance; }
.hp-cta { display: inline-block; margin-top: 14px; font-size: 11px; font-weight: 600; letter-spacing: 0.1em; text-transform: uppercase; color: rgba(255,255,255,0.45); border-bottom: 1px solid rgba(255,255,255,0.2); padding-bottom: 2px; transition: color 0.2s, border-color 0.2s; }
...
.section-more { font-size: 13px; font-weight: 500; color: var(--text); opacity: 0.5; border-bottom: 1px solid currentColor; padding-bottom: 1px; transition: opacity 0.15s; }
...
.card { display: block; }
.card-img { aspect-ratio: 16/10; overflow: hidden; background: #e4e4e0; margin-bottom: 18px; }
...
.card-title { font-family: var(--serif); font-size: 1.3rem; line-height: 1.22; color: var(--text); margin-bottom: 10px; transition: color 0.15s; }
.card:hover .card-title { color: var(--accent); }
.card-blurb { font-size: 14px; color: var(--muted); line-height: 1.65; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }

.wcard { display: grid; grid-template-columns: 1.1fr 1fr; gap: 64px; align-items: center; }
...
.wcard-title { font-family: var(--serif); font-size: clamp(1.75rem, 3vw, 2.75rem); line-height: 1.12; margin-bottom: 20px; transition: color 0.15s; }
...
.wcard-link { display: inline-flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 600; letter-spacing: 0.04em; color: var(--text); border-bottom: 1.5px solid currentColor; padding-bottom: 2px; transition: color 0.15s; }
...
.art-cat { display: inline-block; font-size: 12px; font-weight: 600; letter-spacing: 0.14em; text-transform: uppercase; margin-bottom: 18px; }
...
.art-body blockquote { font-family: var(--serif); font-style: italic; font-size: 1.4rem; color: var(--muted); border-left: 3px solid var(--accent); padding: 4px 0 4px 24px; margin: 2em 0; line-height: 1.48; }
